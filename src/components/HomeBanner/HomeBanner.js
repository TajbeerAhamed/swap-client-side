...
<div className="flex justify-center w-full py-2 gap-2">
  <a href="#item1" className="btn btn-sm text-white bg-red-600">1</a> 
  <a href="#item2" className="btn btn-sm text-white bg-red-600">2</a> 
  <a href="#item3" className="btn btn-sm text-white bg-red-600">3</a> 
  <a href="#item4" className="btn btn-sm text-white bg-red-600">4</a>
  <a href="#item5" className="btn btn-sm text-white bg-red-600">5</a>
  <a href="#item6" className="btn btn-sm text-white bg-red-600">6</a>
</div>
        </div>
    );
};
