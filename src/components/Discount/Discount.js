...
const Discount = () => {
    return (
        <div>
            <div className="px-8 py-2 bg-red-600 text-white mt-10 w-3/5 mx-auto ">
	<div className="flex items-center mx-auto container justify-center md:justify-between py-2">
		<div>
			<span>Get up to 50% off your first order + free shipping,&nbsp;</span>
			<Link to='/signup' rel="noopener noreferrer" className="underline">signUp</Link>today!
		</div>
		<Link to='/' rel="noopener noreferrer" className="items-center gap-2 hidden md:flex">
